...
struct TerrainTriangle
{
	...
	{
		D3DXPLANE returnVal;
		D3DXPlaneFromPoints( &returnVal, (const D3DXVECTOR3*)&v1, (const D3DXVECTOR3*)&v2, (const D3DXVECTOR3*)&v3 );
		return returnVal;
	}
...
public:
	...
	Vector3D GetNormal( float x, float y );
	...
	/// <param name="y"></param>
	/// <returns></returns>
	TerrainTriangle* GetTrianglesAtGridLocation( int x, int y );
